...
import { SubmitProgram } from 'src/submit/submit-program/entities/submit-program.entity';
import { TestCase } from 'src/test-cases/entities/test-case.entity';
...
export const databaseProviders = TypeOrmModule.forRoot({
  ...
  entities: [Auth, Program, Mcq, Candidate, Invite, Test, TestCase, SubmitProgram],
  synchronize: true,
  logging: true,
  cache: true,
